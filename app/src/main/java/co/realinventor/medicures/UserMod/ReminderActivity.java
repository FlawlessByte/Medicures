...
public class ReminderActivity extends AppCompatActivity {
        ...
        ringtoneSelectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RingtonePickerDialog.Builder ringtonePickerBuilder = new RingtonePickerDialog
                        .Builder(ReminderActivity.this, getSupportFragmentManager())
    ...
    private void createAlarm(){
        initDatabase();
        addAlarmToDatabase(medicineName, ""+time.getHour(), ""+time.getMinute());
    ...
    static void addAlarmToDatabase(String medicine, String hour, String minute) {
        db.execSQL("INSERT INTO " + AlarmsOpenHelper.TABLE_NAME +
                " (" + AlarmsOpenHelper.COLUMN_MEDICINE + ", " + AlarmsOpenHelper.COLUMN_HOUR + "," +
                AlarmsOpenHelper.COLUMN_MINUTE + ") VALUES ('" +
                medicine + "', '" +hour+ "', '"+ minute + "');");
    }
